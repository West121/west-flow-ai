...
public class AiRegistryBootstrapService {
    ...
    private void syncTools() {
        ...
        upsertTool(new ToolSeed("ai_tool_009", "plm.project.query", "查询 PLM 项目", "PLATFORM", "READ", "ai:plm:assist", "{\"resource\":\"plm-project\",\"businessDomains\":[\"PLM\"],\"triggerKeywords\":[\"PLM\",\"项目\",\"里程碑\",\"阶段\",\"交付\"],\"routePrefixes\":[\"/plm/projects\"],\"mcpCode\":\"westflow-internal-mcp\",\"priority\":93}"));
        upsertTool(new ToolSeed("ai_tool_007", "feature.catalog.query", "查询功能目录", "PLATFORM", "READ", "ai:copilot:open", "{\"resource\":\"feature-catalog\",\"businessDomains\":[\"OA\",\"PLM\",\"GENERAL\"],\"triggerKeywords\":[\"功能\",\"能力\",\"能做什么\",\"系统功能\",\"怎么用\"],\"routePrefixes\":[\"/system/\",\"/oa/\",\"/plm/\",\"/workflow/\",\"/workbench/\",\"/home\",\"/settings\",\"/ai\"],\"mcpCode\":\"westflow-internal-mcp\",\"priority\":75}"));
        upsertTool(new ToolSeed("ai_tool_008", "user.profile.query", "查询用户资料", "PLATFORM", "READ", "ai:copilot:open", "{\"resource\":\"system-user\",\"businessDomains\":[\"SYSTEM\",\"GENERAL\",\"OA\",\"PLM\"],\"triggerKeywords\":[\"部门\",\"岗位\",\"职位\",\"公司\",\"手机号\",\"邮箱\",\"资料\",\"详情\"],\"routePrefixes\":[\"/system/\",\"/oa/\",\"/plm/\",\"/workflow/\",\"/workbench/\",\"/home\",\"/settings\",\"/ai\"],\"mcpCode\":\"westflow-internal-mcp\",\"priority\":88}"));
        ...
        upsertTool(new ToolSeed("ai_tool_legacy_006", "plm.project.summary", "查询 PLM 项目", "SKILL", "READ", "ai:plm:assist", "{\"aliasOf\":\"plm.project.query\",\"businessDomains\":[\"PLM\"],\"triggerKeywords\":[\"PLM\",\"项目\",\"里程碑\",\"阶段\",\"交付\"],\"routePrefixes\":[\"/plm/projects\"],\"mcpCode\":\"westflow-internal-mcp\",\"priority\":94}"));

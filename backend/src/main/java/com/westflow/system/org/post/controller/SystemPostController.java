package com.westflow.system.org.post.controller;
...
public class SystemPostController {
    ...
    public ApiResponse<java.util.List<SystemAssociatedUserResponse>> relatedUsers(@PathVariable String postId) {
        return ApiResponse.success(systemPostService.relatedUsers(postId));
    }

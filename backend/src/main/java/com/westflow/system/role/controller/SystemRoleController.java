...
public class SystemRoleController {
    ...
    public ApiResponse<java.util.List<SystemAssociatedUserResponse>> relatedUsers(@PathVariable String roleId) {
        return ApiResponse.success(systemRoleService.relatedUsers(roleId));
    }
